...
# Wed Sep 6 10:28:16 CEST 2017                                         #
# Autor: Leonid Burmistrov, Vsevolod Yeroshenko                        #
#                                                                      #
# Script description:                                                  #
#                     This script perform data convertation            #
#                     of USB-WC RAW-data on pc-corto2. This script     #
#                     executed with screen.                            #
#                                                                      #
# Input paramete: NON                                                  #
#                                                                      #
#                                                                      #
...
then
    ...
    echo ""
    echo "----------------------------------------------------" 
    echo " ERROR --> Impossible to make file convertation     " 
...
echo " --> File convertation is in process !!! "
...
screen -S $CORTOWINSCREENNAMECONV -L -d -m ./makeFileconv.bash
